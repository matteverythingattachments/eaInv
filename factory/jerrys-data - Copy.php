...
//echo file_get_contents("https://www.everythingattachments.com/v/vspfiles/schema/Generic/jerrys_data.asp?startmonth=01&startyear=2018&endmonth=07&endyear=2019");
...
<body>
 ...
 <table id="frighttable" style="margin-top:30px;">
   ...
   <?php echo $table_data; ?>
   <tr><td></td><td>Total Items:</td><td> <?php echo $tcount; ?></td><td></td><td class="hdata"></td><td class="hdata"></td><td class="hdata"></td><td class="hdata"></td><td></td><td></td><td><?php echo money_format('%.2n', $totalshort); ?></td></tr>
  </table>
  <br /><br />
