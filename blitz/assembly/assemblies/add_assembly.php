...
if(isset($_POST['assemblyName']))	{
	...
	if(mysqli_num_rows($preCheckQuery) > 0)	{
		...
		mysqli_query($mysqli, "INSERT INTO assemblies (Name, Description, Qty, MinQty, MaxQty, ReorderValue, Location, category) VALUES
('$_POST[assemblyName]','$_POST[assemblyDescription]','$_POST[Qty]','$_POST[MinQty]','$_POST[MaxQty]','$_POST[ReorderValue]','$_POST[Location]','$_POST[Category]')") or die(mysqli_error($mysqli));
