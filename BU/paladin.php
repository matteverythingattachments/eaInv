...
$runningTotal = 0;
$cat_query = mysqli_query($conn,"SELECT NAME FROM BRADCO_CATS order by ID ASC") or die(mysqli_error());
...
$nav_query = mysqli_query($conn,"SELECT * FROM BRADCO_CATS ORDER BY NAME ASC") or die(mysqli_error());
?>
<!DOCTYPE HTML>
<html>
<head>
